...
func TestAccKsyunScalingPoliciesDataSource_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataScalingPoliciesConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIDExists("data.ksyun_scaling_policies.foo"),
				),
			},
		},
	})
...
const testAccDataScalingPoliciesConfig = `
...
data "ksyun_scaling_policies" "foo" {
