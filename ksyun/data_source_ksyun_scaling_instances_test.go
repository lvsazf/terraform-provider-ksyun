...
func TestAccKsyunScalingInstancesDataSource_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataScalingInstancesConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIDExists("data.ksyun_scaling_instances.foo"),
				),
			},
		},
	})
...
const testAccDataScalingInstancesConfig = `
...
data "ksyun_scaling_instances" "foo" {
