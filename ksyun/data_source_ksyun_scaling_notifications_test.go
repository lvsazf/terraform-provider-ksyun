...
func TestAccKsyunScalingNotificationsDataSource_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataScalingNotificationsConfig,
			},
		},
	})
}

const testAccDataScalingNotificationsConfig = `
...
data "ksyun_scaling_notifications" "foo" {
