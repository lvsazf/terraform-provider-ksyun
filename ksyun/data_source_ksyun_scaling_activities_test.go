...
func TestAccKsyunScalingActivitiesDataSource_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataScalingActivitiesConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIDExists("data.ksyun_scaling_activities.foo"),
				),
			},
		},
	})
...
const testAccDataScalingActivitiesConfig = `
...
data "ksyun_scaling_activities" "foo" {
